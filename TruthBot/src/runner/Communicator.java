...
public class Communicator {
    ...
    public void run() {
        ...
        try {
            ...
            TruthBot bot =  new TruthBot("none", 0,0,0,20, new ArrayList<Player>());
            ...
            while ((input = inStream.readLine()) != null) {
                ...
                if ("GETACTION".compareToIgnoreCase(word) == 0) {
                    ...
                    bot = new TruthBot(botName, stackSize, bigBlind, numHands, timeBank, Arrays.asList(new Player[]{player1,player2}));
